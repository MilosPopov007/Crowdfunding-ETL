...
-- Using the "backers" table confirm the results in the first query.
 SELECT COUNT (backer_id) AS "backer_count_number"
 FROM backers
 GROUP BY cf_id
 ORDER BY backer_count_number DESC;
...
-- 4. (5 pts)
-- Create a table, "email_backers_remaining_goal_amount" that contains the email address of each backer in descending order(last_name ASC) 
